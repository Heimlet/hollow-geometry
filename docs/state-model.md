...
`starfield.js` — декоративный фон с двумя яркостными слоями и постоянной экранной
плотностью для обеих камер. По умолчанию 2400 звёзд, диапазон 200–8000; количество
