...
const terms = [
  ...
  ['detail._metatron_.nodes', 'плод и цветок жизни|(?:плод(?:а|у|ом|е)?|цвет(?:ок|ка|ку|ком|ке)) жизни'],
  ...
  ['group.merkaba', 'зв[её]здн(?:ый|ого|ому|ым|ом) тетраэдр(?:а|у|ом|е)?|два тетраэдра|двух тетраэдров'],
