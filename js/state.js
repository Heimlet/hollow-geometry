...
export function initialState() {
  ...
  display: { autoRotate: false, speed: .15, stars: true, starCount: 2400, gentleOrbit:true, torusHeight:true, torusInner:true, torusOuter:true, torusRounded:true, torusSpiral:true, torusTetrahedra:true, guide: false, golden: false } });
}
  ...
  switch (action.type) {
    ...
    case 'display/change': {
      requireValid(Object.entries(action.patch).every(([key, value]) => key === 'starCount'
        ...
        : ['autoRotate', 'stars', 'guide', 'golden', 'gentleOrbit', 'torusHeight', 'torusInner', 'torusOuter', 'torusRounded', 'torusSpiral', 'torusTetrahedra'].includes(key) && typeof value === 'boolean'), 'Invalid display settings');
