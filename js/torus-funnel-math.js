...
// The second, conical layer is the exact surface of revolution of the guides.
// Every golden step multiplies rho and |z| together; rho/|z| stays sqrt(2).
export const SPIRAL_FUNNEL_EXTENT=PHI**SPIRAL_WINDOW.to;
export const spiralFunnelRadius=z=>Math.SQRT2*Math.abs(z);
export function spiralFunnelPoint(angle,t,a=A){const z=t*a,r=spiralFunnelRadius(z);return [r*Math.cos(angle),r*Math.sin(angle),z];}
